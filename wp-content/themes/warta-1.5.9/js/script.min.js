...
+function(i){"use strict";i("input, textarea").placeholder(),i(".article-medium .image").click(function(){var t=i(this),o=t.find(".container-link"),a=t.find(".container-link .link");setTimeout(function(){0==o.css("opacity")?(o.css("opacity",1),a.css("top","50%"),t.data("force-hover",!0)):t.data("force-hover")&&(o.css("opacity",0),t.data("force-hover",!1))},300)}),Modernizr.csstransitions||i(".fa-flip-horizontal").removeClass("fa-flip-horizontal")}(jQuery);